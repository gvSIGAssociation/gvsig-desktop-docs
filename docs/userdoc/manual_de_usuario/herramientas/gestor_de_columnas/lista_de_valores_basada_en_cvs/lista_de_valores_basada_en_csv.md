...
![1_newTable_128](lista_de_valores_basada_en_csv.img/1_newTable-128.png)
...
![2_newTableFileAdd_128](lista_de_valores_basada_en_csv.img/2_newTableFileAdd-128.png)
...
![3_newTableFileProp_128](lista_de_valores_basada_en_csv.img/3_newTableFileProp-128.png)

Este comando despliega la ***ventana Parámetros de carga del csv***, la cual presenta dos pestaña.
* Básica.
* Avanzada.

![4_newTableProperties_128](lista_de_valores_basada_en_csv.img/4_newTableProperties-128.png)

La ***pestaña básica*** se muestra en la siguiente ilustración.

![5_newTableBasicProperties_128](lista_de_valores_basada_en_csv.img/5_newTableBasicProperties-128.png)
...
![6_newTableAdvancedProperties_128](lista_de_valores_basada_en_csv.img/6_newTableAdvancedProperties-128.png)
...
![7_openTableBBDD_128](lista_de_valores_basada_en_csv.img/7_openTableBBDD-128.png)
...
![8_openTableBBDD_128](lista_de_valores_basada_en_csv.img/8_openTableBBDD-128.png)

A continuación se muestra las dos tablas en cuestión.

![9_tables_128](lista_de_valores_basada_en_csv.img/9_tables-128.png)
